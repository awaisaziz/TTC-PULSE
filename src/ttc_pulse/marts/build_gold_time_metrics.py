...
PARQUET_PATH = ROOT_DIR / "gold" / "gold_time_reliability.parquet"
...
def main() -> None:
    ...
    append_ingestion_log(
        step="build_gold_time_metrics",
        status="SUCCESS",
        row_count=row_count,
        output_path=to_rel_posix(PARQUET_PATH),
        details="Weekday x hour reliability mart with weighted composite score built.",
    )
