...
PARQUET_PATH = ROOT_DIR / "gold" / "gold_station_time_metrics.parquet"
...
def main() -> None:
    ...
    append_ingestion_log(
        step="build_gold_station_metrics",
        status="SUCCESS",
        row_count=row_count,
        output_path=to_rel_posix(PARQUET_PATH),
        details="Station x time reliability metrics with weighted composite score built.",
    )
