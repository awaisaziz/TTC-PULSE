...
TABLE_NAME = "raw_bus_delay_events_registry"
...
def main() -> None:
    ...
    records = build_registry_records(
        files=source_files,
        dataset_name="bus_delay_events",
        source_type="historical_bus_delay_logs",
    )

    csv_output = RAW_DIR / "bus" / "raw_bus_delay_events_registry.csv"
    parquet_output = RAW_DIR / "bus" / "raw_bus_delay_events_registry.parquet"
